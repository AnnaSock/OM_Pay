...
class SendCredentialsSms implements ShouldQueue
{
    ...
    public function handle(OtpVerified $event): void
    {
        try {
            ...
            // Message avec les identifiants
            $message = "OM Pay - Vos identifiants :\nLogin: {$event->login}\nMot de passe: {$event->password}\n\nConservez ces informations en sécurité.";
            ...
            // Log de succès
            Log::info("Identifiants envoyés avec succès à {$to}", [
